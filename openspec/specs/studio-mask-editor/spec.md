# Studio Mask Editor Specification

## Purpose

Defines the target-bound full-screen mask editing, viewport, drawing, history, preview, PNG upload, and safe-close requirements for Routego Studio.

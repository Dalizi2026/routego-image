...
const copy = {
  zh: {
    ...
    title: "中转配置与生成默认参数",
    lead: "管理脱敏提供方资料、写入型密钥和生成默认值。敏感值不会进入诊断或持久浏览器状态。",
    ...
    advancedSettingsHelp: "提供方资料、默认参数和输出目录",
    active: "当前启用",
    inactive: "未启用",
    profiles: "提供方资料",
    ...
    redacted: "脱敏端点",
    modelRefresh: "模型清单刷新",
    nonBillable: "非计费操作：仅读取模型清单，不发送图像请求。",
    refreshModels: "刷新模型（非计费）",
    refreshedModels: "已验证模型",
    model: "模型",
    defaults: "生成默认值",
    defaultsLead: "保存完整默认对象，并同步已挂载工作台中仅由默认值派生的控制项；提示词和当前任务不会被替换。",
    size: "尺寸",
    aspect: "宽高比",
    quality: "质量",
    format: "格式",
  ...
  en: {
    eyebrow: "CONTROL ROOM / 04",
    title: "Relay configuration & generation defaults",
    lead: "Manage redacted provider profiles, write-only keys, and generation defaults. Sensitive values never enter diagnostics or persistent browser state.",
    firstRunEyebrow: "FIRST RUN / LOCAL SETUP",
    ...
    advancedSettingsHelp: "Provider profiles, defaults, and output directory",
    active: "Active",
    inactive: "Inactive",
    ...
    nonBillable: "Non-billable: this only reads the model catalogue and does not send an image request.",
    refreshModels: "Refresh models (non-billable)",
    refreshedModels: "Validated models",
    model: "Model",
    defaults: "Generation defaults",
    defaultsLead: "Save one complete defaults object and synchronize only default-derived controls in the mounted workbench; prompts and the active task are preserved.",
    size: "Size",
    aspect: "Aspect ratio",
    quality: "Quality",
    format: "Format",

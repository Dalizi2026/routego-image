...
- accepted task 3.3 implementation：`a7b939cb75d5ec170b105f7fe8f5b94a24ec7bce`
- accepted task 3.3 checkpoint：`941a119db3f2054da2bca97d6e0ccaa0188da991`
- OpenSpec：13/29，next `3.4`
- G3 是唯一 apply owner；G2 已归档；3.3 已由 Controller 独立验收；3.4 已解锁但尚未开始
- 当前 task capsule：`.codex/routego-program/tasks/integration-3.4.json`
...
直接 `send_message_to_thread` 后 `read_thread` 回读是主链；30 分钟自动化只做漏报兜底。G3 只能先执行 3.4，并在任务/任务组/checkpoint/阻塞/偏差/交付后立即直报 Controller 与回读确认。

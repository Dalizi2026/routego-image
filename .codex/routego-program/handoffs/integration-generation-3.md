...
- G2 仍是冻结的唯一 apply owner；G3 未登记、未接受、未激活；3.2 锁定
...
successor 只读取 capsule 的 mandatoryFiles，最多 12 个文件、120 KiB。acceptance 前若发生一次上下文压缩，发送 `HANDOFF_CONTEXT_BUDGET_FAILED` 并停止；验证器失败发送 `HANDOFF_AUDIT_FAILED`。
